...
c.fonts.tabs.unselected = '18pt'
  '';
    ...
    home.file.".browser/Personal/config/qute-home.html".text = generateHomepage "Personal" userSettings.font config;
    ...
    home.file.".browser/WebDev/config/qute-home.html".text = generateHomepage "WebDev" userSettings.font config;
    home.file.".browser/WebDev/config/logo.png".source = ./qutebrowser-logo.png;
    home.file.".browser/NixOS/config/qute-home.html".text = generateHomepage "NixOS" userSettings.font config;
