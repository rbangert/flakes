{ pkgs, config, lib, ... }: {
  ...
  networking.hosts = {
    "10.0.0.101" = [ "code.rr-sv.win" ];
  };

  security.acme.acceptTerms = true;
  security.acme.defaults.email = "russ@rr-sv.win";

  services.nginx = {
    enable = true;

    # Use recomme`nded settings
  ...
  services.nginx.virtualHosts."docs.rr-sv.win" = {
    forceSSL = false;
    enableACME = true;
    root = "/srv";
  };

  services.nginx.virtualHosts."dev.rr-sv.win" = {
  ...
  virtualisation.oci-containers.containers = {
    coder = {
      ...
      volumes = [
        "/srv/dev.rr-sv.win:/home/coder:cached"
      ...
      environment = {
        ...
        CODER_ACCESS_URL = "https://dev.rr-sv.win";
